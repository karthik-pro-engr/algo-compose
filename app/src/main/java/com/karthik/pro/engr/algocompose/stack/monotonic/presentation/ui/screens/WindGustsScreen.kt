...
fun WindGustsScreen(modifier: Modifier = Modifier, onBack: () -> Unit) {
    ...
    val monotonicViewModel: MonotonicViewModel<Int> =
        viewModel(key = "WindGustsScreen", factory = monotonicViewModelFactory)

    val monotonicScreenConfig = MonotonicScreenConfig<Int>(
        titleRes = R.string.monotonic_wind_gusts_title,
        bodyRes = R.string.monotonic_wind_gusts_body,
        inputLabelRes = R.string.monotonic_wind_gusts_label_input,
        inputPlaceholderRes = R.string.monotonic_wind_gusts_placeholder_input,
        inputButtonRes = R.string.monotonic_wind_gusts_button_add_speed,
        noItemInfosRes = R.string.monotonic_wind_gusts_no_items_info,
        computeButtonRes = R.string.monotonic_wind_gusts_button_compute,
        unitSuffix = "km/h",
